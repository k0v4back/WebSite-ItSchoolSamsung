...
<!--                <li class="nav-item">-->
<!--                    <a class="nav-link js-scroll-trigger" href="--><?php //$logo;?><!--/#services">Services</a>-->
<!--                </li>-->
                <!-- <li class="nav-item">
                  <a class="nav-link js-scroll-trigger" href="#portfolio">Portfolio</a>
                </li> -->
<!--                <li class="nav-item">-->
<!--                    <a class="nav-link js-scroll-trigger" href="--><?php //$logo;?><!--/#about" >О нас</a>-->
<!--                </li>-->
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="<?php $logo;?>/#team">Команда</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="<?php $logo;?>/#contact">Контакты</a>
                </li>
...
<!--                </li>-->
<!--                <li class="nav-item">-->
<!--                    <a class="nav-link js-scroll-trigger" href="--><?php //$logo;?><!--/#about"></a>-->
<!--                </li>-->
